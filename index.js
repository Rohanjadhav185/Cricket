...
xhttp.onreadystatechange = function() {
  if (this.readyState == 4 && this.status == 200) {
    // Server se response mil gaya hai, aur wo 200 OK hai
    console.log(this.responseText); // Server ka response console par print karen
  }
};
xhttp.open("GET", "example.php", true); // example.php endpoint par GET request bheje
xhttp.send(); // Request ko bhejne ke liye send() function ka use karein
